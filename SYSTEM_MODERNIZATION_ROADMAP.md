...
| **J11** ⭐ | **UUID de una óptica real hardcodeado como fallback global** | `opticaActual.js` define `OPTICA_ID_DEFAULT` — un UUID real — como respaldo para cualquier visitante sin slug resuelto | Reemplazar por una resolución explícita de "óptica no encontrada" (página de error), no un fallback silencioso a una óptica real | Arquitectura de un solo tenant sobreviviendo dentro de un sistema multi-tenant; un visitante sin slug termina viendo datos de una óptica que no es la suya | 🟠 ALTA | Medio | Media |
...
| 🟠 ALTA | 19 (4 ✅ hechos: E5, E6, I10, J2 — 15 restantes) | B6 ⭐, C1, C4, D1, E4, ~~E5~~ ⭐, ~~E6~~ ⭐, E7 ⭐, G4, G5 ⭐, G6, I3, I4, ~~I10~~ ⭐, I11 ⭐, J1, ~~J2~~, J11 ⭐, J12 ⭐ |
